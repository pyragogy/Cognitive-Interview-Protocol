# Pyragogy Cognitive Interview Protocol (CIP‑KGE) v0.3.2

<div align="center">

[![Status](https://img.shields.io/badge/status-Open%20Reference%20Architecture-purple?style=flat-square)](docs/ROADMAP.md)
[![Version](https://img.shields.io/badge/version-v0.3.2-blue?style=flat-square)](docs/PROTOCOL.md)
...
## What changed from v0.2.1 → v0.3.2
...
**CIP-KGE v0.3.2** — Epistemic governance protocol for evidence-based knowledge-graph evolution<br>
